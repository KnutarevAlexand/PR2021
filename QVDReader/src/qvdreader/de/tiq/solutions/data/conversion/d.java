...
class d {
  ...
  private d(File paramFile1, File paramFile2, byte[] paramArrayOfbyte) {
    this.d = new FileInputStream(paramFile1);
    this.e = new FileInputStream(paramFile2);
    this.f = a(paramArrayOfbyte);
  }
  
  private d(File paramFile1, File paramFile2, FileInputStream paramFileInputStream) {
    this(paramFile1, paramFile2, IOUtils.toByteArray(paramFileInputStream));
  }
  
  private d(InputStream paramInputStream1, InputStream paramInputStream2, InputStream paramInputStream3) {
...
/* Location:              C:\Users\operator\Desktop\QVDReader.jar!\de\tiq\solutions\data\conversion\d.class
