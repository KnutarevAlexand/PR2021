...
public class Person {   //внешний класс
    ...
    public static void main(String[] args) {
        ...
        class PushkinPension implements Function{ //анонимный класс описывает анонимную функцию
        ...
        System.out.println(p.getPension( new PushkinPension()));  //задействуется анонимный класс когда нужно задействовать один раз
