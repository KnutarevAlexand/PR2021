...
public class BinaryReader {
    ...
    private static String FileName = "C:\\JDeveloper\\mywork\\javaprogramming\\KnutarevAlexandr\\PR2021\\src\\p8\\15_05_11_SSR_50996_83E73535A56D1F4CBC8F47EB685C6808.wav";
    ...
    public static void main(String[] args) {
            ...
            if (offset < bytes.length) {
                ...
                MD5 = null;
                File_ID = null;
                logError("Could not completely read file " + fileIn.getName());
            } else {
                byte[] md5sum = digest.digest();
                BigInteger bigInt = new BigInteger(1, md5sum);
                byte[] BinaryOut = bytes;
                MD5 = bigInt.toString(16);
                logInfo("Successfully read file " + fileIn.getName() + ",ID: " + File_ID + ", of size " + bytes.length + " bytes, with MD5 checksum: \"" + MD5 + "\"");
                }
            }else {
                synchronized(lock) {
                    countNullRows++;
